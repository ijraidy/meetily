...
pub async fn complete_onboarding<R: Runtime>(
    ...
    // Save transcription model config: local multilingual Whisper so Arabic and mixed
    // Arabic/English meetings transcribe out of the box (Parakeet v3 has no Arabic).
